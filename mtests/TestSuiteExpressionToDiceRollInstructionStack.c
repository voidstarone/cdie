...
void test_dice_roll_instruction_stack_from_expression_subtract(void) {
    ...
    CU_ASSERT_EQUAL(dice_roll_instruction_get_number(result), 8);
...
void test_dice_roll_instruction_stack_from_expression_divide(void) {
    ...
    DiceRollInstruction* result = dice_roll_instruction_stack_evaluate(dris);
    CU_ASSERT_EQUAL(dice_roll_instruction_get_number(result), 5.0);
...
void test_dice_roll_instruction_stack_from_expression_add_multiply(void) {
    ...
    CU_ASSERT_EQUAL(instruction3->operation_type, op_type_number);
    CU_ASSERT_EQUAL(dice_roll_instruction_get_number(instruction3), 8.2);
    DiceRollInstruction *instruction4 = dyn_array_element_at_index(dris->instructions, 1);
    CU_ASSERT_EQUAL(instruction4->operation_type, op_type_multiply);
    ...
    DiceRollInstruction* result = dice_roll_instruction_stack_evaluate(dris);
    double result_num = dice_roll_instruction_get_number(result);
...
void test_dice_roll_instruction_stack_from_expression_subtract_multiply(void) {
    ...
    DiceRollInstruction *instruction3 = dyn_array_element_at_index(dris->instructions, 2);
    CU_ASSERT_EQUAL(instruction3->operation_type, op_type_number);
    CU_ASSERT_EQUAL(dice_roll_instruction_get_number(instruction3), 8);
    DiceRollInstruction *instruction4 = dyn_array_element_at_index(dris->instructions, 1);
    CU_ASSERT_EQUAL(instruction4->operation_type, op_type_multiply);
